...
console.log(numeros)
const strings = ["Olá", "boa tarde.", "Labenu"]
console.log(strings)
const terceiroArray = [29, "laranja", true]
console.log(terceiroArray)
console.log(terceiroArray.length)

const meusNumerosCopia = [5, 10, 30]
console.log(meusNumerosCopia)
meusNumerosCopia.unshift(35)
meusNumerosCopia2 = meusNumerosCopia.slice()
console.log(meusNumerosCopia)
console.log(meusNumerosCopia2)
const ultimonumero = meusNumerosCopia2.pop()
console.log(ultimonumero)
console.log(meusNumerosCopia2)
terceiroArray2 = terceiroArray.slice()
console.log(terceiroArray)
console.log(terceiroArray2)
